  ...
  <div>
    ...
    <div class="gradient-overlay-half-primary-video-v1" data-vide-bg="assets/video/bg2" data-vide-options="position: 0% 50%;">
      ...
      <!-- <div class="js-bg-video d-none d-md-block position-absolute w-100 h-100"
           ...
           data-hs-bgv-id="X4tUY12u2Nk"
           data-hs-bgv-loop="true">
      </div> -->

      <video class="" poster="" autoplay muted loop>
          <source src="@/assets/buzzradar/media/html5-video/test_universe.mp4" type="video/mp4">
          <!-- <source src="@/assets/buzzradar/media/html5-video/bg.webm" type="video/webm"> -->
          <!-- <source src="@/assets/buzzradar/media/html5-video/bg.ogv" type="video/ogg"> -->
                ...
                <div class="container position-relative z-index-2">
                  ...
                  <div class="text-left mb-7">
                    ...
                    <div class="w-lg-80 mx-auto">
                      <h1 class="display-4 font-size-md-down-5 text-white mb-3"><span class="font-weight-semi-bold">Unlock</span> your social and audience data with smarter insights</h1>
                    </div>
    ...
    <div class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll bg-white" data-options='{direction: "normal"}'>
      ...
      <div class="container space-2 space-md-3">
        <div class="row align-items-lg-center">
          ...
          <div id="SVGellipseMockup2" class="col-md-5 offset-md-1 svg-preloader">

            <!-- Play Button Js-Fancybox -->
            <a class="js-fancybox u-media-player u-media-player--centered" href="#"
    ...
    <div class="bg-light">
      <div class="container space-2 space-lg-3">
        ...
        <div class="w-md-80 w-lg-50 text-center mx-md-auto mb-9">
          <h2 class="font-weight-medium">A suite of powerful tools all in one easy to use platform</h2>
        </div>
        <!-- End Title -->
            ...
            <div class="tab-content pr-lg-4">
              ...
              <div class="tab-pane fade" id="pills-two-code-features" role="tabpanel" aria-labelledby="pills-two-code-features-tab">
                <div class="shadow-sm rounded">
                  <img class="img-fluid rounded-lg" src="@/assets/img/900x900/img2.jpg" alt="Image Description">
                </div>
              </div>

              <div class="tab-pane fade" id="pills-three-code-features" role="tabpanel" aria-labelledby="pills-three-code-features-tab">
                <img class="img-fluid rounded-lg" src="@/assets/img/900x900/img3.jpg" alt="Image Description">
              </div>
            </div>
            <!-- End Tab Content -->
          </div>
        ...
        <div class="js-slick-carousel u-slick"
          ...
          <div class="js-slide">
            <div class="text-center mb-5">
              <blockquote class="h4 text-lh-md">The template is really nice and offers quite a large set of options. It's beautiful and the coding is done quickly and seamlessly. Thank you!</blockquote>
            </div>
          ...
          <div class="js-slide">
            <div class="text-center mb-5">
              <blockquote class="h4 text-lh-md">It's beautiful and the coding is done quickly and seamlessly. Keep it up!</blockquote>
            </div>
            <div class="d-flex justify-content-center align-items-center w-lg-50 mx-auto">
              <div class="u-avatar">
              ...
              <div class="ml-3">
                <h4 class="h6 mb-0">James Austin</h4>
  ...
  export default {
    ...
    data () {
      return {
        ...
        testimonialBgImage : {
          backgroundImage : 'url('+require('@/assets/buzzradar/img/1920x600/jeremy.jpg')+')',
        },
