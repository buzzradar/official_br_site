            ...
            <div class="col-lg-6 mb-3">
              ...
              <div class="col-md-12">
                ...
                <form class="js-validate card shadow-sm p-5">
                  ...
                  <button v-on:click="checkForm()" type="button" class="btn btn-ces transition-3d-hover btn-submit-form">Get The Report</button>
