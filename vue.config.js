...
const SEORoutes = {
	...
	titles : {
	    '/': 'Real Time Social Media Artificial Intelligence Tool Made Easy - Buzz Radar',
	    '/realtimedashboard': 'Real-Time Dashboard - Buzz Radar',
	    '/aiaudienceanalysis': 'Truly understand your audience with Artificial Intelligence - Buzz Radar',
	    '/marketingintelplatform': 'Marketing Intelligence Tool, Business Actionable Insights Marketing - Buzz Radar',	   
	  	'/marketingintelplatform/socialintelligence' : 'Social Media Influencer Analysis, Social Media Listening - Buzz Radar',
	  	'/marketingintelplatform/paidmedia': 'Paid Media Analysis, Reports & Intelligent Alerts - Buzz Radar',
	  	'/marketingintelplatform/newspr': 'News & PR Monitoring across over 3 Million news outlet - Buzz Radar',
	  	'/blog': 'Blog - Buzz Radar',
	  	'/casestudies': 'Case Studies - Buzz Radar',
	  	'/ces': 'CES 2021 - Buzz Radar',
	  	'/ces-personalities': 'CES 2021 - Buzz Radar',
	  	'/virtualevents': 'Virtual Events are key and popular these days - Buzz Radar',
		'/services': 'Credible Influence - The AI Audience Intelligence, Social Insight and Content Optimisation Agency',
	...
	descriptions : {
	    ...
	    '/marketingintelplatform': 'In a few clicks take your organisations marketing data and turn it into actionable insights marketing.',	   
	  	...
	  	'/virtualevents': 'With the many events this year turning virtual, utilising and understanding the online conversation around them has become increasingly important.',
		'/services': 'Credible Influence - The AI Powered Audience Intelligence, Social Insight and Content Optimisation Agency',
	...
	sharerImages : {
		...
		'/services': 'https://www.buzzradar.com/public_assets/images/sharers/sharer_services.jpg',
